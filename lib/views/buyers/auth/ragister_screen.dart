...
import 'package:eshop/views/buyers/auth/login_screen.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:image_picker/image_picker.dart';

class BuyerRagisterScreen extends StatefulWidget {
  const BuyerRagisterScreen({super.key});

  @override
  State<BuyerRagisterScreen> createState() => _BuyerRagisterScreenState();
}

class _BuyerRagisterScreenState extends State<BuyerRagisterScreen> {
  ...
  _signUpUser() async {
    ...
    if (_formkey.currentState!.validate()) {
      ...
      return showSnack(
          context, 'Customer is ragister successfully!', Colors.green.shade700);
    } else {
      _isLoading = false;
      return showSnack(
